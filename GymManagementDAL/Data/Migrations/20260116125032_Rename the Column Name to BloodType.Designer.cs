...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20260116125032_Rename the Column Name to BloodType")]
    partial class RenametheColumnNametoBloodType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("GymUserCheckValidation", "Email Like '_%@_%._%'");

                            t.HasCheckConstraint("GymUserPhoneCheckValidation", "Phone Like '01%' and Phone not Like '[^0-9]%'");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("GymUserCheckValidation", "Email Like '_%@_%._%'")
                                .HasName("GymUserCheckValidation1");

                            t.HasCheckConstraint("GymUserPhoneCheckValidation", "Phone Like '01%' and Phone not Like '[^0-9]%'")
                                .HasName("GymUserPhoneCheckValidation1");
                        });
                });
