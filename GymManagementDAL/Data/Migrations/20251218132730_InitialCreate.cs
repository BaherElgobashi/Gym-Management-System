        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserCheckValidation", "Email Like '_%@_%._%'");
                    table.CheckConstraint("GymUserPhoneCheckValidation", "Phone Like '01%' and Phone not Like '[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserCheckValidation1", "Email Like '_%@_%._%'");
                    table.CheckConstraint("GymUserPhoneCheckValidation1", "Phone Like '01%' and Phone not Like '[^0-9]%'");
                });
